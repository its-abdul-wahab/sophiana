          ...
          <div className="relative sm:flex justify-between items-center gap-[5.5rem] xl:gap-[9.25rem]">
            ...
            <div className="flex-1 sm:relative text-center sm:text-left absolute top-1/2 -translate-y-1/2 sm:-translate-y-0 px-10 sm:px-0">
                ...
                <p className="text-base sm:text-lg mb-8 sm:my-4 font-crimson-regular  leading-snug sm:text-primary text-white">
                  Sofiana redefines luxury reselling by providing exclusive
                  access to a selection of highly curated luxury jewelry,
                  watches, and artworks to our digital reseller network.
                  Eliminate the challenges of time-consuming product searches
                  and photography by leveraging our SHOWROOM—a comprehensive
                  tool for your selling success.
                </p>
                <Link to="/contact-us">
                  <Button
