    ...
    >
      <div className="max-w-[564px] mx-auto mb-8 sm:mb-10">
        <p className="font-crimson-regular text-lg sm:text-2xl text-center mb-4 sm:mt-9 px-16 sm:px-0">
          <span className="italic font-crimson-semibold">Sophiana</span> - A new
          digital place where you dance with diamonds and mingle with
          masterpieces. Get ready for a luxurious rendezvous with breathtaking
          jewels, art, and exclusive leather goods. Sign up now and stay tuned.
        </p>
      </div>
      <Link to="/contact-us">
